#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_RESOURCES_VULKAN_RENDER_TARGET_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_RESOURCES_VULKAN_RENDER_TARGET_HPP
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_RESOURCES_VULKAN_RENDER_TARGET_HPP
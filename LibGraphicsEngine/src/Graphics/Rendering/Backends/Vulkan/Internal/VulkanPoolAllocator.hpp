#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_POOL_ALLOCATOR_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_POOL_ALLOCATOR_HPP
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_POOL_ALLOCATOR_HPP
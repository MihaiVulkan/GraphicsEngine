#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_LOGICAL_DEVICE_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_LOGICAL_DEVICE_HPP
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_LOGICAL_DEVICE_HPP
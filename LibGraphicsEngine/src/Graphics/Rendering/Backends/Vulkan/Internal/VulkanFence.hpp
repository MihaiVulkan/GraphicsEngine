#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_FENCE_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_FENCE_HPP
...
namespace GraphicsEngine
{
	namespace Graphics
	{
		...
		*/
		...
		{
			GE_RTTI(GraphicsEngine::Graphics::VulkanFence)
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_FENCE_HPP
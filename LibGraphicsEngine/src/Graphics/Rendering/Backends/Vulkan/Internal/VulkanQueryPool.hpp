#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_QUERY_POOL_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_QUERY_POOL_HPP
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_QUERY_POOL_HPP
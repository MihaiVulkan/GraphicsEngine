#ifndef GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_SURFACE_HPP
#define GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_SURFACE_HPP
...
#endif // GRAPHICS_RENDERING_BACKENDS_VULKAN_INTERNAL_VULKAN_SURFACE_HPP
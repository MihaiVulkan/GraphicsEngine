#ifndef GRAPHICS_RENDERING_VULKAN_COMMON_VULKAN_COMMON_HPP
#define GRAPHICS_RENDERING_VULKAN_COMMON_VULKAN_COMMON_HPP
...
#endif // GRAPHICS_RENDERING_VULKAN_COMMON_VULKAN_COMMON_HPP
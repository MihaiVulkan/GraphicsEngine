...
#include "Graphics/Rendering/Vulkan/Internal/VulkanImage.hpp"
#include "Graphics/Rendering/Vulkan/Internal/VulkanImageView.hpp"
#include "Graphics/Rendering/Vulkan/Internal/VulkanSampler.hpp"
...
VkImageType GADRTexture::TypeToVulkanType(const Texture::Type& type) const
{
...
VkFilter GADRTexture::FilterModeToVulkanFilterMode(const Texture::FilterMode& filterMode) const
{
	...
	case Texture::FilterMode::FM_LINEAR:
		...
		break;
	case Texture::FilterMode::FM_COUNT:
	default:
...
VkSamplerMipmapMode GADRTexture::MipMapModeToVulkanMipMapMode(const Texture::MipMapMode& mipMapMode) const
{
	...
	case Texture::MipMapMode::MM_LINEAR:
		...
		break;
	case Texture::MipMapMode::MM_COUNT:
	default:

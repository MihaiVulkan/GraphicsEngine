#ifndef GRAPHICS_RENDERING_VULKAN_RESOURCES_VULKAN_RENDER_FRAME_BUFFER_HPP
#define GRAPHICS_RENDERING_VULKAN_RESOURCES_VULKAN_RENDER_FRAME_BUFFER_HPP
...
#endif // GRAPHICS_RENDERING_VULKAN_RESOURCES_VULKAN_RENDER_FRAME_BUFFER_HPP
#ifndef GRAPHICS_RENDERING_VULKAN_DESCRIPTOR_SET_LAYOUT_HPP
#define GRAPHICS_RENDERING_VULKAN_DESCRIPTOR_SET_LAYOUT_HPP
...
#endif // GRAPHICS_RENDERING_VULKAN_DESCRIPTOR_SET_LAYOUT_HPP
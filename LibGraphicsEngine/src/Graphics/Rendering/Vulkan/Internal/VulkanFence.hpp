#ifndef GRAPHICS_RENDERING_VULKAN_INTERNAL_VULKAN_FENCE_HPP
#define GRAPHICS_RENDERING_VULKAN_INTERNAL_VULKAN_FENCE_HPP
...
#endif // GRAPHICS_RENDERING_VULKAN_INTERNAL_VULKAN_FENCE_HPP